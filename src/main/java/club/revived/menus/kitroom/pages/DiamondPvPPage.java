...
public class DiamondPvPPage extends InventoryBuilder {

    public DiamondPvPPage(Player player, boolean b){
        ...
        addCloseHandler(event -> Bukkit.getScheduler().runTaskLater(LegacyKits.getInstance(), () -> {
            ...
            if(b){
                ...
                KitRoomCache.saveKitRoomPage(KitroomPage.DIAMOND_CRYSTAL, content);
            }
        }, 1));
    }
}
